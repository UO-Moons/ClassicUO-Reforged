...
namespace ClassicUO.Configuration
{
    internal static class ProfileManager
    {
        ...
        private static void ValidateFields(Profile profile)
        {
            ...
            if (!Enum.IsDefined(typeof(AccessibilityPreset), profile.AccessibilityPreset))
            {
                profile.AccessibilityPreset = AccessibilityPreset.Default;
            }

            if (!Enum.IsDefined(typeof(AccessibilityColorMode), profile.AccessibilityColorMode))
            {
